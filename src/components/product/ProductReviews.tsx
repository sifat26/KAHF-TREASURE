  ...
  return (
    <section aria-label="Customer reviews">
      ...
      {REVIEWS_ARE_PLACEHOLDER && (
        <p className="mb-5 rounded-lg border border-dashed border-line bg-surface px-4 py-2 text-xs text-muted">
      ...
      <ul className="flex flex-col gap-5">
        {list.map((review) => (
          <li key={review.id} className="rounded-[var(--radius-card)] border border-line bg-canvas p-5">
